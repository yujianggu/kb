...
![TQM 质量价值流概览](./TQM-质量价值流概览.png)

*图：PQA 正向策划将客户需求转化为质量结果，QTR 逆向改进将问题与经验回流到下一轮策划；IVDP 质量门提供阶段决策控制，质量工程与质量体系提供横向支撑。图中箭头表示价值传递与反馈关系，不要求各职能活动严格串行。*

## 11. 质量价值流模型

如上方概览图所示，TQM 不只是职能分工，而是一条从客户需求到客户体验，再回流到下一轮策划的端到端价值流。
